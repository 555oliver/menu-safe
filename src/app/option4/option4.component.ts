...
import { CustomExpansionPanel4Component } from '../custom-expansion-panel-4/custom-expansion-panel-4.component';

@Component({
  selector: 'app-option4',
  standalone: true,
  imports: [MaterialModule, CustomExpansionPanel4Component],
  templateUrl: './option4.component.html',
  styleUrl: './option4.component.scss'
})
