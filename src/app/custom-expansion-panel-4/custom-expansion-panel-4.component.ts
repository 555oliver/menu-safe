...
@Component({
  selector: 'app-custom-expansion-panel-4',
  standalone: true,
  imports: [MaterialModule],
  templateUrl: './custom-expansion-panel-4.component.html',
  styleUrl: './custom-expansion-panel-4.component.scss'
})
export class CustomExpansionPanel4Component {
  @Input() title?: string;
